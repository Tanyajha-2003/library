...
let AuthorsController = class AuthorsController {
    ...
    find(id) { return this.svc.find(Number(id)); }
    update(id, body) { return this.svc.update(Number(id), body); }
    delete(id) { return this.svc.delete(Number(id)); }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AuthorsController.prototype, "list", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", void 0)
], AuthorsController.prototype, "find", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
